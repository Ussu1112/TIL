...
public class TransactionDAO {
    ...
    public void transfer(Transaction transaction) throws SQLException {
        String query = "INSERT INTO transaction_tb (transaction_amount," +
                "transaction_w_balance, transaction_d_balance, transaction_w_account_number," +
                "transaction_d_account_number, transaction_created_at) VALUES (?, ?, ?, ?, ?, now())";
